...
var iLove = 'I love';
var iLoveCode = iLove + " code";// #3  Make an object called bob and give it the following properties
...
var bob = {
	...
	hair: {style: "spikey",
		color: "brown"},
	presidentOfTheUnitedStates: false,	likes: ["apples","bananas","cherries"]
};
...
return array.filter(v => v !== string); 
};
